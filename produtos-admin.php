...
<body class="img-fluid">
    ...
    <?php
        ...
        $resultado = ProdutoBD::allProduto();
        $index = 1;
    ?>
    <div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Alterar Produto <?php echo $row ['nome']?></h5>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form id="formulario" method="post" action="BDaccess/BDaccess.php?bd=ProdutoBD&acao=alterar&id=<?php echo $row['id']?>" name="formulario">
                                        <div class="form-row">
                                        ...
                                        <div >
                                            <button type="submit" class="col-md-5 btn" style="background-color: #7dffb1; color: white; box-sizing: border-box; width: 50%; float: left;">Salvar Alterações</button>
                                        </div>    
                                    </form> 
                                    <form id="formulario2" method="post" action="BDaccess/BDaccess.php?bd=ProdutoBD&acao=deletar&id=<?php echo $row['id']?>" name="formulario2">
            ...
            <div class="modal fade" id="modalInserir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <form id="formulario" method="post" action="BDaccess/BDaccess.php?bd=ProdutoBD&acao=inserir" name="formulario">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                            <label for="inputImg">Arquivo de Imagem</label>
                                            <input type="file" class="" id="inputImg" name="imagem" value="padrao.jpg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inputDesc" name="nome" placeholder="Ex: Osso">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress">Descrição</label>
                                            <textarea type="text" class="form-control" id="inputDesc" name="descricao" placeholder="[Texto...]"></textarea>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-6">   
                                                ...
                                                <input type="number" class="form-control" id="inputPreco" name="quantidade" placeholder="0">
                                            </div>
                                        </div>
